...
* **Student Grading Rubric (75pt)**
  ...
  * Game Dynamics (25 pt)
    1. Allow the user to start the game by clicking start on the start screen. (5 pt)
    2. Have a health bar for the character. (5 pt) 
    3. Allow the character to win by reaching a flag. (5 pt)
    4. Allow the user to restart the game. (5 pt)
    5. Have background game music. (5 pt)
  * Character's actions (15 pt)
    1. Make cat show running animation if it runs either forwards or backwards. (5 pt)
    2. Display cat's damage animation when it gets hit by a monster. (5 pt)
    3. Have a sound effect for cat's shooting attack. (5 pt)
